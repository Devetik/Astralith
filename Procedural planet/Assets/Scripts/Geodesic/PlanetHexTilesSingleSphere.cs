...
/// <summary>
/// Version avec une seule sphère - tuiles hexagonales individuelles
/// </summary>
public class PlanetHexTilesSingleSphere : MonoBehaviour
{
    ...
    void Start()
    {
        if (showDebugInfo)
        {
            Debug.Log("=== DÉBUT TUILES HEXAGONALES - UNE SEULE SPHÈRE ===");
        }
