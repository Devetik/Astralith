...
/// <summary>
/// Version ultra-simple des tuiles hexagonales sans tags personnalisés
/// </summary>
public class PlanetHexTilesUltraSimple : MonoBehaviour
{
    ...
    void Start()
    {
        if (showDebugInfo)
        {
            Debug.Log("=== DÉBUT TUILES HEXAGONALES ULTRA-SIMPLE ===");
        }
    ...
    private void CreateHexTile(PlanetHexWorld.Cell cell)
    {
        ...
        // Crée le mesh hexagonal simple
        Mesh hexMesh = CreateSimpleHexMesh(cell);
    ...
    /// <summary>
    /// Crée un mesh hexagonal simple
    /// </summary>
    private Mesh CreateSimpleHexMesh(PlanetHexWorld.Cell cell)
    {
        Mesh mesh = new Mesh();
        ...
        // Crée un hexagone simple dans le plan tangent
        ...
        for (int i = 0; i < hexSides; i++)
        {
            ...
            Vector3 offset = (tangent1 * Mathf.Cos(angle) + tangent2 * Mathf.Sin(angle)) * 0.05f;
